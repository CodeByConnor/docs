...
<Note>
  Source: [docs.ramp.com](https://docs.ramp.com/developer-api/v1/webhooks) — plain-text export `llms-guides`. This page is migrated for Mintlify; verify details on the live site if needed.
</Note>

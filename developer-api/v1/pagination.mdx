---
title: "Pagination"
description: "Pagination allows you to retrieve an entire dataset with a series of requests, where each request fetches a portion of the data set. By loading data in smaller chunks, pagination reduces the amount of data transmitted per response and alleviates the load on the servers, ensuring faster loading times"
icon: "gears"
---

<Note>
  Source: [docs.ramp.com](https://docs.ramp.com/developer-api/v1/pagination) — plain-text export `llms-guides`. This page is migrated for Mintlify; verify details on the live site if needed.
</Note>
